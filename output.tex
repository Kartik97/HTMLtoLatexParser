...
: $\Alpha$ $\Gamma$ $\Theta$ $\Xi$ $\Pi$ 
 ...
 \section*{LaTeX commands in HTML} \par It's easy to include LaTeX commands in HTML comments.\begin{comment}
 latex:  
\LaTeX{} greets you.
\end{comment} \\ 
 
 \section*{Different font styles and sizes.} \par Lorem ipsum \fontsize{ 32pt}{12pt}\selectfont dolor\normalsize
...
.
{}  
 \section*{Images} \par \begin{comment}
